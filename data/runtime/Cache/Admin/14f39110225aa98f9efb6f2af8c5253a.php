...
<head>
    ...
    <link href="/resume/public/js/artDialog/skins/default.css" rel="stylesheet" />
...
<!-- Le javascript
    ...
    <script src="/resume/public/js/wind.js"></script>
...
<body>
	<div class="wrap">
		...
		<div class="home_info">
			<ul id="thinkcmf_notices">
				<li><img src="/resume/admin/themes/simplebootx/Public/assets/images/loading.gif"style="vertical-align: middle;" /><span style="display: inline-block; vertical-align: middle;">加载中...</span></li>
			</ul>
		</div>
	...
	<script src="/resume/public/js/common.js"></script>
	<script>
		//获取官方通知

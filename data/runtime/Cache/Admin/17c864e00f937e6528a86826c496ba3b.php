...
<html>
	<head>
		...
		<link href="/resume/admin/themes/simplebootx/Public/assets/css/admin_login.css" rel="stylesheet" />
		<style>
			#login_btn_wraper{
				text-align: center;
			}
...
<body>
	<div class="wrap">
		<h1><a href="/resume">ThinkCMF <?php echo L('ADMIN_CENTER');?></a></h1>
...
var GV = {
	DIMAUB: "",
	JS_ROOT: "/resume/public/js/",//js版本号
	TOKEN : ''	//token ajax全局
};
</script>
<script src="/resume/public/js/wind.js"></script>
<script src="/resume/public/js/jquery.js"></script>
<script type="text/javascript" src="/resume/public/js/common.js"></script>
<script>
;(function(){

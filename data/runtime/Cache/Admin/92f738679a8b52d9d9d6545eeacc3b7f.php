...
<link href="/resume/public/simpleboot/themes/<?php echo C('SP_ADMIN_STYLE');?>/theme.min.css" rel="stylesheet">
<link href="/resume/public/simpleboot/css/simplebootadmin.css" rel="stylesheet">
<link href="/resume/public/simpleboot/font-awesome/4.4.0/css/font-awesome.min.css"  rel="stylesheet" type="text/css">
<!--[if IE 7]>
	<link rel="stylesheet" href="/resume/public/simpleboot/font-awesome/4.4.0/css/font-awesome-ie7.min.css">
<![endif]-->
<link rel="stylesheet" href="/resume/public/simpleboot/themes/<?php echo C('SP_ADMIN_STYLE');?>/simplebootadminindex.min.css?">
<!--[if lte IE 8]>
	<link rel="stylesheet" href="/resume/public/simpleboot/css/simplebootadminindex-ie.css?" />
<![endif]-->
<style>
...
<body style="min-width:900px;" screen_capture_injected="true">
	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<img src="/resume/admin/themes/simplebootx/Public/assets/images/logo-18.png">
						ThinkCMF <?php echo L('ADMIN_CENTER');?>
				</small>
				</a>
				<div class="pull-left nav_shortcuts" >
					
					<a class="btn btn-small btn-warning" href="/resume/" title="<?php echo L('WEBSITE_HOME_PAGE');?>" target="_blank">
				...
				<ul class="nav simplewind-nav pull-right">
					<li class="light-blue">
						<a data-toggle="dropdown" href="#" class="dropdown-toggle">
							...
							<?php else: ?>
								<img class="nav-user-photo" width="30" height="30" src="/resume/admin/themes/simplebootx/Public/assets/images/logo-18.png" alt="<?php echo ($admin["user_login"]); ?>"><?php endif; ?>
	...
	<script src="/resume/public/js/jquery.js"></script>
	<script src="/resume/public/simpleboot/bootstrap/js/bootstrap.min.js"></script>
	<script>
	...
	<script src="/resume/admin/themes/simplebootx/Public/assets/js/index.js"></script>
</body>
</html>